...
echo -e "${BLUE}➡️  Moving python-blinds-webserver.service to /lib/systemd/system and set permissions...${NC}"
...
echo -e "${BLUE}▶️  Enabling python-blinds-webserver service and restart it...${NC}"
